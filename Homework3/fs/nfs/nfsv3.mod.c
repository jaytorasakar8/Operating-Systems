...
__attribute__((section("__versions"))) = {
	...
	{ 0x2d20f207, __VMLINUX_SYMBOL_STR(nfs_get_client) },
	...
	{ 0x3e8b7c4a, __VMLINUX_SYMBOL_STR(nfs_post_op_update_inode) },
	...
	{ 0x88f13f43, __VMLINUX_SYMBOL_STR(forget_all_cached_acls) },
...
MODULE_INFO(srcversion, "EAA64F5F4A5B3E7C2A1AFFA");
